...
<p></p><p></p>
<h3 class="text-center normal-weight" align="left">
<?php
    $isYes = false;
    if (isset($estateClient['haspoweratty'])){
        if ($estateClient['haspoweratty'] == "Yes" or $estateClient['haspoweratty'] == "Yes"){
            $isYes = true;
        }
    }
    ?>
    ...
    <?php else: ?>
        <b style="font-size: 18px;">&#9744;</b>
    <?php endif; ?>
    <b><?php echo $name; ?> Enduring Power of Attorney</b>
</h3>
<table cellpadding="1" cellspacing="1">
  <tr>
      <td width="33%">
