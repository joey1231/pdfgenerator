...
?>
<h2 class="sectionn-title">YOUR LIABILITIES</h2>
<p></p><p></p>
...
<div class="">
  ...
  <table class="table ff-table" style="font-size:110%" cellpadding="5">
    ...
    <?php if ($first['clientInfo']['firstname'] != null): ?>
      <tr>
        <td colspan="3" class="value" align="right">Total liabilities owned by <?php echo $first['clientInfo']['firstname']; ?>:</td>
        <td class="value">$ <?php echo moneyFormatter("%n", $clientAssets); ?></td>
      </tr>
    <?php endif; ?>
    <?php if ($first['partnerInfo']['firstname'] != null): ?>
      <tr>
        <td colspan="3" class="value" align="right">Total liabilities owned by <?php echo $first['partnerInfo']['firstname']; ?>:</td>
        <td class="value">$ <?php echo moneyFormatter("%n", $partnerAssets); ?></td>
      </tr>
    <?php endif; ?>
    <tr>
      <td colspan="3" class="value" align="right"><b>Total liabilities:</b></td>
