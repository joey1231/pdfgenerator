...
<table width="100%" cellspacing="5">
	...
	<tr>
		...
		<td width="2%">&nbsp;</td>
		<!-- <td width="57%"><h1>Client Needs Analysis<br />and Fact Find</h1></td> -->
		<td width="57%"><h1>Client(s)<br />Insurance<br />Planner</h1></td>
	...
	<tr><td>&nbsp;</td></tr>
	<tr>
		<td width="100%" align="center" style="font-size:175%">
			<?php
				$text = "";
