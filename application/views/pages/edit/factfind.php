                  ...
                  <div class="wizard" style="margin-top:-50px">
                    <div class="wizard-inner">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation" class="disabled" data-target='summary' data-step='6' data-title="Update Fact Find Document">
                                <a href="#complete" data-toggle="tab" aria-controls="complete" role="tab" title="Complete">
                                    <span class="round-tab">
                     ...
                     <div id='generate-info-data'>
                       <div id='generate-info-form' style='padding:20px'>
                         ...
                         <div class='row'>
                           ...
                           <div class='col-md-4 col-sm-4'>
                             ...
                             <div class="btn-group btn-block" id="preview-doc-cont">
                               ...
                               <ul class="dropdown-menu">
                                 <li><a href="#" id="preview-document-btn">Preview Document</a></li>
                           ...
                           <div class='col-md-4 col-sm-4'>
                             <button class='btn btn-fill btn-primary btn-block' id="save-document-btn" disabled='disabled'>
                               Document not loaded
                             </button>
                           </div>
                         </div>
      ...
      $.ajax({
           ...
           error: function(){
             ...
             $('#preview-document-btn')
               .attr('disabled', 'disabled')
               .html("Document not loaded. Please try again.");

               $("#save-document-btn")
                 .attr('disabled', 'disabled')
                 .html("Document not loaded. Please try again.");
               //context.find('.modal-body').html("<h3>Document stopped loading. Please try again.</h3>");
           }
      });
