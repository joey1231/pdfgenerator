        ...
        <div role="tabpanel" class="tab-pane fade in active" id="loa-items">
            <div class='row'>
              <div class='col-md-4 col-sm-4'>
                ...
                <div class="checkbox text-left"><label><input type="checkbox" checked="checked" class="info-fld">
              ...
              <div class='col-md-8 col-sm-8'>
               ...
               <div class='col-md-8 col-md-offset-4 col-sm-8'>
                <h3>Partner person/s:</h3>
                <div id='loa-partner-persons'>
                  <table class='table'>
                    <thead>
                      <tr>
                        <th>Name</th><th>Address</th><th>DOB</th><th>Contact Details</th><th></th>
                ...
                <br /><br />
                <h4>Add a partner person</h4>
                <div class='partner-person-form'>
                  ...
                  <div class='row col-md-12'>
                    <button class='btn btn-primary' id='add-partner-person-btn' >Add partner Person</button>
                  </div>
                </div>
...
var fetchLOA = function(){
    ...
    $("#loa-partner-persons tbody").find('tr').each(function(){
        var item = {};
        item.name = $(this).find("td:eq(0)").html();
        item.homeaddress = $(this).find("td:eq(1)").attr('data-ha');
        item.suburb = $(this).find("td:eq(1)").attr('data-sub');
...
$(document).ready(function(){
    ...
    $('#add-partner-person-btn').click(function(){
        var form = $('.partner-person-form');
        var dataset = [];
        ...
        var html = "<tr class='partner-person-item'>";
        html += "<td>"+dataset[0]+"</td>";
        // Address
        var address = dataset[2]+" "+dataset[3]+" "+dataset[4]+" "+dataset[5];
        html += "<td data-ha='"+dataset[2]+"' data-sub='"+dataset[3]+"' data-town='"+dataset[4]+"' data-post='"+dataset[5]+"'>"+address+"</td>";
        ...
        var contacts = dataset[6]+" "+dataset[7];
        html += "<td data-email='"+dataset[6]+"' data-phone='"+dataset[7]+"'>"+contacts+"</td>";
        html += '<td><button type="button" class="close partner-person-close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></td>';
        html += "</tr>";

        $('#loa-partner-persons').find('tbody').append(html);
        $('.partner-person-close').click(function(){
            $(this).parent().parent().remove();
        });
