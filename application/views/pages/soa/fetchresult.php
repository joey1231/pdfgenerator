...
<div style="font-size:120%">
  ...
  <p>This Statement of Advice is a record of our meeting on <span class="red"><?php echo date("d M Y", $_trans->timestamp); ?></span>, in which we discussed your personal financial circumstances and established what advice you sought in relation to your personal debt and risk insurance.</p>
...
<table class="table ff-table" cellpadding="5" style="font-size:115%">
  ...
  <tr>
    ...
    <td><?php echo $data; print_r($split); ?></td>
  ...
  <tr>
    ...
    <?php $person = $first->clientInfo; $data = $person->grosswages; $data = $data == null ? "$ 0.00" : "$ ".money_format("%n", floatval($data)); ?>
    <td><?php echo $data; ?></td>
    <?php $person = $first->partnerInfo; $data = $person->grosswages;  $data = $data == null ? "$ 0.00" : "$ ".money_format("%n", floatval($data)); ?>
    <td><?php echo $data; ?></td>
  </tr>
  <tr><td></td></tr>
  <tr class='head-table'>
