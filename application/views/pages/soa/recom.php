          ...
          <div class='col-md-12'>
            ...
            <div class="tab-content">
              <div role="tabpanel" data-owner='client' class="tab-pane active" id="client-recom-<?php echo $_GET['i']; ?>">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Recommend for Client?</label>
                      <select class="form-control recommend-switch" data-target='client'>
                        <option value="0">No. Do not recommend.</option>
                        <option value="1">Yes. Recommend.</option>
                      </select>
                    </div>
                  </div>
                </div>
                <br />
                <div class='row client-recom-item-div' style="display:none">
                    ...
                    <div class='col-md-12 col-sm-12 form-group provider-item-parent'>
                ...
                <div class='row client-recom-item-div' align='left' style="display:none">
              ...
              <div role="tabpanel" data-owner='partner' class="tab-pane" id="partner-recom-<?php echo $_GET['i']; ?>">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Recommend for Partner?</label>
                      <select class="form-control recommend-switch" data-target='partner'>
                        <option value="0">No. Do not recommend.</option>
                        <option value="1">Yes. Recommend.</option>
                      </select>
                    </div>
                ...
                <br />
                <div class='row partner-recom-item-div' style="display:none">
                ...
                <div class='row partner-recom-item-div' align='left' style="display:none">
                  <div class='col-md-6'>
                    <h5>Enter your recommendations here.</h5>
                    <div>
                      <div class='form-group'>
...
$(document).ready(function(){
  ...
  $('.recommend-switch').change(function(){
      var target = $(this).attr('data-target');
      var value = $(this).val();
      var ctx;

      if (target == "client"){
          ctx = $('.client-recom-item-div');
      } else {
          ctx = $('.partner-recom-item-div');
      }
